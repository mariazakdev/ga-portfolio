...
// import goodEyesGame from "../assets/10DCtmp.png";
...
const PROJECTS = [
  ...
  {
    id: "good-eyes-game",
    fileLabel: "Good Eyes Game",
    img: goodEyesGame,
    link: "https://rypir.itch.io", // Added itch.io URL
    summary: [
      "In my game that I have developed, i.e. Good Eyes Game, I intend that you, as a player (Proofreader and Tester), would need to find as many mistakes/issues/bugs as possible in the two mini educational games. The two games you can choose from are the “Letter Game” and the “Color Game.” You would have to use your attention to detail skills, problem-solving skills, and your thinking outside the box skills.",
    ],
  },
];
          ...
          {PROJECTS.map((p) => (
            <article key={p.id} className="projects__card">
              ...
              <div className="projects__card-text">
                ...
                {/* Renders the link if a project has one defined */}
                {p.link && (
                  <p className="projects__card-p">
                    <a
                      href={p.link}
                      target="_blank"
